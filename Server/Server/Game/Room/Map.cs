...
namespace Server.Game
{
    ...
    public struct Vector2Int
    {
        ...
        public float magintude { get { return (float)Math.Sqrt(sqrMagnitude); } }
    ...
    public class Map
    {
        ...
        private bool[,] collisionArr;
        GameObject[,] objects;

        public bool IsMoveable(Vector2Int cellPosition, bool checkObjects = true)
        {
            if (cellPosition.x < MinX || cellPosition.x > MaxX) return false;
            if (cellPosition.y < MinY || cellPosition.y > MaxY) return false;
        ...
        public bool ApplyLeave(GameObject gameObject)
        {
            ...
            PositionInfo posInfo = gameObject.Info.PositionInfo;
        ...
        public bool ApplyMove(GameObject gameObject, Vector2Int dest)
        {
            ...
            PositionInfo posInfo = gameObject.Info.PositionInfo;
            if (IsMoveable(dest, true) == false)
                return false;

            {
                int x = dest.x - MinX;
                int y = MaxY - dest.y;
                objects[y, x] = gameObject;
            }
        ...
        public void LoadMap(int mapId, string pathPrefix = "../../../../../Common/MapData")
        {
            ...
            // Collision 관련 파일
            text = File.ReadAllText($"{pathPrefix}/{mapName}.txt");
            ...
            collisionArr = new bool[yCnt, xCnt];
            objects = new GameObject[yCnt, xCnt];
            ...
            for (int y = 0; y < yCnt; y++)
            {
                ...
                {
                    collisionArr[y, x] = (line[x] == '1' ? true : false);
                }
            }
        }
        ...
        public List<Vector2Int> FindPath(Vector2Int startCellPos, Vector2Int destCellPos, bool checkObjects = true)
        {
            ...
            while (pq.Count > 0)
            {
                ...
                for (int i = 0; i < _deltaY.Length; i++)
                {
                    ...
                    {
                        if (IsMoveable(Pos2Cell(next), checkObjects) == false) // CellPos
                            continue;
                    }
